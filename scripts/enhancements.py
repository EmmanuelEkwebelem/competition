...
NoShowData.drop(['id', 'patient_id_2', 'appointment_id', 'appointment_status', 'appointment_date', 'appointment_start_time', 'appointment_yosi_noshow2', 
...
NewColumnOrder = ['practice_id', 'patient_id', 'appointment_type', 'patient_dob', 'patient_age', 'patient_gender', 'patient_age_group', 'appointment_date_time', 
